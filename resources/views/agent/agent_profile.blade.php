                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('agent.profile.store') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="exampleInputUsername1"
                                            autocomplete="off" value="{{ $profileData->phone }}" placeholder="phone">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Address</label>
                                        <input type="text" name="address" class="form-control" id="exampleInputUsername1"
                                            autocomplete="off" value="{{ $profileData->address }}" placeholder="address">
                                    </div>
