                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{--  <form method="POST" action="{{ route('post.update', $post->id) }}" class="forms-sample"
                                enctype="multipart/form-data">  --}}

                                <form method="POST" action="{{ route('post.update',$post->id) }}" class="forms-sample" enctype="multipart/form-data">
{{--  {{ dd($post->id) }}  --}}
                                @csrf
                                @method('PUT')
