        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="testimonials">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('testimonial.index') }}" class="nav-link">All Testimonials</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('testimonial.create') }}" class="nav-link">Add Testimonials</a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="blogcategory">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('blog.index') }}" class="nav-link">All Blog Category </a>
                        </li>
                    </ul>
                </div>
            </li>
