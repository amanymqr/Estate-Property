                                ...
                                <form method="POST" action="{{ route('admin.update.password') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="old_password"
                                            ...
                                            id="exampleInputUsername1" autocomplete="new-password"
                                            value="{{ $profileData->password }}" placeholder="current password">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="new_password"
                                            ...
                                            id="exampleInputUsername1" autocomplete="off" value=""
