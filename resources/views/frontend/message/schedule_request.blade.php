                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($schedule_request as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->status == 1)
                                                            <span class="badge rounded-pill text-white p-2 bg-success">Confirm</span>
                                                        @else
                                                            <span class="badge rounded-pill text-white p-2 bg-danger">Pending</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
