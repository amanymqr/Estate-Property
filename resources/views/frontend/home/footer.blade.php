                        ...
                        <div class="post-inner">
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html"><img
                                            src="{{ asset('frontendassets/images/resource/footer-post-1.jpg') }}"
                                            alt=""></a></figure>
                            ...
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html"><img
                                            src="{{ asset('frontendassets/images/resource/footer-post-2.jpg') }}"
                                            alt=""></a></figure>
        ...
        <div class="auto-container">
            <div class="inner-box clearfix">
                <figure class="footer-logo"><a href="index.html"><img
                            src="{{ asset('frontendassets/images/footer-logo.png') }}" alt=""></a>
                </figure>
